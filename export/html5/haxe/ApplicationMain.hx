...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SpaceRhythm", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SpaceRhythm", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "SpaceRhythm";
		app.meta["name"] = "SpaceRhythm";
